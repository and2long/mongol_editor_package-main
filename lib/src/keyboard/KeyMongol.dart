            ...
            child: Container(
              ...
              child: Stack(
                children: [
                      ...
                      child: RotatedBox(
                        ...
                        child: Text(
                          mglShiftChar != null && controller.onShift
                              ...
                              : mglChar,
                          style: TextStyle(
                            // fontSize: 16.sp,    //fxing the font size is not good, if the phone font size change.
                  ...
                  //       title,
                  //       style: TextStyle(
                  //           fontFamily: MongolFonts.z52ordostig, fontSize: 12),
                  //     ))   //Latin Letter on the keyboard
                ],
              ),
            ),
          ),
